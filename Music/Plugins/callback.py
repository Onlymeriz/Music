...
async def pausevc(_, CallbackQuery):
    ...
    if await is_active_chat(chat_id):
        if await is_music_playing(chat_id):
            ...
            await CallbackQuery.answer("II Voicechat Paused", show_alert=True)
            user_id = CallbackQuery.from_user.id
            user_name = CallbackQuery.from_user.first_name
            rpk = "[" + user_name + "](tg://user?id=" + str(user_id) + ")"
            await CallbackQuery.message.reply(
                f"II Lagu Dijeda oleh {rpk}!", reply_markup=play_keyboard
            )
            await CallbackQuery.message.delete()
        else:
...
"""
            ...
            await CallbackQuery.answer("‣‣I Obrolan Suara Dilewati", show_alert=True)
...
"""
                ...
                await CallbackQuery.message.reply_photo(
                    ...
                    caption=(
                        f"""
<b>**📀 Melewati lagu permintaan** {rpk}</b>
