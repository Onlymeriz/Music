...
def start_pannel():
    buttons = [
        ...
        [
            InlineKeyboardButton("ᴘᴇʀɪɴᴛᴀʜ​", url="https://t.me/kontenfilm/38"),
            InlineKeyboardButton("sᴏᴜʀᴄᴇ", url="https://github.com/Onlymeriz/KynanMusic"),
        ],
        [
...
pstart_markup = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton("ᴘᴇʀɪɴᴛᴀʜ", url="https://t.me/kontenfilm/38"),
            InlineKeyboardButton("ᴏᴡɴᴇʀ", url="https://t.me/Riizzvbss"),
        ],
        [
        InlineKeyboardButton(text="ᴅᴏɴᴀsɪ ❤️", url=f"https://t.me/Riizzvbss"),
        ],
...
❤️ **Jangan lupa untuk menjadikan saya sebagai admin di grup ini**
""",
...
@Client.on_message(
    filters.group
    & filters.command(
        ["mstart", "mstart", f"mstart@{BOT_USERNAME}", f"mhelp@{BOT_USERNAME}"]
    )
)
...
😎 Untuk Mengetahui Semua Perintah Bot Dan Bagaimana Cara Kerja Nya Dengan Menekan Tombol » ᴘᴇʀɪɴᴛᴀʜ​!**
