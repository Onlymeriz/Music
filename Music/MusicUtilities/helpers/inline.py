...
def search_markup(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="𝟏", callback_data=f"Music2 {ID1}|{duration1}|{user_id}"
            ),
            InlineKeyboardButton(
                text="𝟐", callback_data=f"Music2 {ID2}|{duration2}|{user_id}"
            ),
            InlineKeyboardButton(
                text="𝟑", callback_data=f"Music2 {ID3}|{duration3}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
                text="𝟒", callback_data=f"Music2 {ID4}|{duration4}|{user_id}"
            ),
            InlineKeyboardButton(
                text="𝟓", callback_data=f"Music2 {ID5}|{duration5}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
...
def search_markup2(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="𝟔", callback_data=f"Music2 {ID6}|{duration6}|{user_id}"
            ),
            InlineKeyboardButton(
                text="𝟕", callback_data=f"Music2 {ID7}|{duration7}|{user_id}"
            ),
            InlineKeyboardButton(
                text="𝟖", callback_data=f"Music2 {ID8}|{duration8}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
                text="𝟗", callback_data=f"Music2 {ID9}|{duration9}|{user_id}"
            ),
            InlineKeyboardButton(
                text="𝟏𝟎", callback_data=f"Music2 {ID10}|{duration10}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
...
start_keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "ᴅᴀꜰᴛᴀʀ ᴘᴇʀɪɴᴛᴀʜ​", url="https://telegra.ph/ҡʏɴλɴ-02-11-2"
            )
        ],
