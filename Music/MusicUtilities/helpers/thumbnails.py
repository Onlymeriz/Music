...
from Music.config import YOUTUBE_IMG_URL
...
async def gen_thumb(videoid, status):
    ...
    try:
        ...
        font = ImageFont.truetype("cache/font.ttf", 40)
        font2 = ImageFont.truetype("cache/Roboto-Medium.ttf", 70)
        arial = ImageFont.truetype("cache/font.ttf", 30)
        name_font = ImageFont.truetype("cache/font.ttf", 30)
